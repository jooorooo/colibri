<?php
/**
 * File for ColibriERPWsdlClass to communicate with SOAP service
 *
 * @category   ColibriERP
 * @package    ColibriERP
 * @subpackage Structs
...
/**
 * ColibriERPWsdlClass to communicate with SOAP service
 *
 * @category   ColibriERP
 * @package    ColibriERP
 * @subpackage Structs
 ...
 * @date       2017-06-01
 */
class ColibriERPWsdlClass extends stdClass implements ArrayAccess, Iterator, Countable
{
    /**
     ...
     * @var string
     */
    const VALUE_WSDL_URL = 'https://demo.colibrierp.com/ws/wsbase.php?wsdl';
    /**
     ...
     * Constructor
     *
     * @uses  ColibriERPWsdlClass::setLastError()
     * @uses  ColibriERPWsdlClass::initSoapClient()
     * @uses  ColibriERPWsdlClass::initInternArrayToIterate()
     * @uses  ColibriERPWsdlClass::_set()
     ...
     *
     * @return ColibriERPWsdlClass|null
     */
    public static function __set_state(array $_array, $_className = __CLASS__)
    {
        if (class_exists($_className)) {
            $object = @new $_className();
            if (is_object($object) && $object instanceof ColibriERPWsdlClass) {
     ...
     *
     * @param SoapClient $_soapClient expect SoapClient
     *
     * @return SoapClient
     */
     ...
     *
     * @uses  ColibriERPClassMap::classMap()
     * @uses  ColibriERPWsdlClass::getDefaultWsdlOptions()
     * @uses  ColibriERPWsdlClass::getSoapClientClassName()
     * @uses  ColibriERPWsdlClass::setSoapClient()
    ...
    {
        $wsdlOptions = array();
        $wsdlOptions['classmap'] = self::classMap();
     ...
     * If a class is named as {ColibriERP}SoapClient, then this is the class that will be used.
    ...
    {
        if (class_exists('ColibriERPSoapClient') && is_subclass_of('ColibriERPSoapClient', 'SoapClient')) {
            return 'ColibriERPSoapClient';
        } else {
            return 'SoapClient';
        }
    }
     ...
     *
     * @uses   ColibriERPWsdlClass::WSDL_CACHE_WSDL
     * @uses   ColibriERPWsdlClass::WSDL_COMPRESSION
     * @uses   ColibriERPWsdlClass::WSDL_CONNECTION_TIMEOUT
     * @uses   ColibriERPWsdlClass::WSDL_ENCODING
     * @uses   ColibriERPWsdlClass::WSDL_EXCEPTIONS
     * @uses   ColibriERPWsdlClass::WSDL_FEATURES
     * @uses   ColibriERPWsdlClass::WSDL_LOGIN
     * @uses   ColibriERPWsdlClass::WSDL_PASSWORD
     * @uses   ColibriERPWsdlClass::WSDL_SOAP_VERSION
     * @uses   ColibriERPWsdlClass::WSDL_STREAM_CONTEXT
     * @uses   ColibriERPWsdlClass::WSDL_TRACE
     * @uses   ColibriERPWsdlClass::WSDL_TYPEMAP
     * @uses   ColibriERPWsdlClass::WSDL_URL
     * @uses   ColibriERPWsdlClass::VALUE_WSDL_URL
     * @uses   ColibriERPWsdlClass::WSDL_USER_AGENT
     * @uses   ColibriERPWsdlClass::WSDL_PROXY_HOST
     * @uses   ColibriERPWsdlClass::WSDL_PROXY_PORT
     * @uses   ColibriERPWsdlClass::WSDL_PROXY_LOGIN
     * @uses   ColibriERPWsdlClass::WSDL_PROXY_PASSWORD
     * @uses   ColibriERPWsdlClass::WSDL_LOCAL_CERT
     * @uses   ColibriERPWsdlClass::WSDL_PASSPHRASE
     * @uses   ColibriERPWsdlClass::WSDL_AUTHENTICATION
     * @uses   ColibriERPWsdlClass::WSDL_SSL_METHOD
     ...
     * @param string $_location expect string
     *
     * @return string
     */
     ...
     * @uses  ColibriERPWsdlClass::getSoapClient()
     * @uses  ColibriERPWsdlClass::getFormatedXml()
     * @uses  SoapClient::__getLastRequest()
     * @param bool $_asDomDocument expect bool
     *
     ...
     * @uses  ColibriERPWsdlClass::getSoapClient()
     * @uses  ColibriERPWsdlClass::convertStringHeadersToArray()
     ...
     *
     * @param string $_headers expect string
     *
     * @return array
     */
     ...
     * @param bool   $_mustUnderstand expect bool
     * @param string $_actor          expect string
     *
     * @return bool true|false
     */
    public function setSoapHeader($_nameSpace, $_name, $_data, $_mustUnderstand = false, $_actor = null)
    {
        if ($soap_client = self::getSoapClient()) {
            $defaultHeaders = (isset($soap_client->__default_headers) && is_array($soap_client->__default_headers)) ? $soap_client->__default_headers : array();
     ...
     *
     * @uses  ColibriERPWsdlClass::getSoapClient()
     * @param string $_headerName  expect string
     * @param mixed  $_headerValue expect mixed
     *
     * @return bool true|false
     */
    public function setHttpHeader($_headerName, $_headerValue)
    {
        if ($soap_client = self::getSoapClient() && !empty($_headerName)) {
            $streamContext = (isset($soap_client->_stream_context) && is_resource($soap_client->_stream_context)) ? $soap_client->_stream_context : null;
            ...
            if (count($options) && array_key_exists('http', $options) && is_array($options['http']) && array_key_exists('header', $options['http']) && is_string($options['http']['header'])) {
                 ...
                 */
                if (!is_resource($streamContext)) {
                    return ($soap_client->_stream_context = stream_context_create($options)) ? true : false;
                    /**
                     * Set the new context http header option
                     */
                } else {
                    return stream_context_set_option($soap_client->_stream_context, 'http', 'header', $options['http']['header']);
                }
            } else {
                return false;
            }
     ...
     *
     * @uses   ColibriERPWsdlClass::count()
     * @return int
     */
     ...
     *
     * @uses   ColibriERPWsdlClass::getInternArrayToIterate()
     * @uses   ColibriERPWsdlClass::getInternArrayToIterateIsArray()
     * @return int
     */
     ...
     *
     * @uses   ColibriERPWsdlClass::offsetGet()
     * @return mixed
     */
     ...
     *
     * @uses   ColibriERPWsdlClass::getInternArrayToIterateOffset()
     * @uses   ColibriERPWsdlClass::setInternArrayToIterateOffset()
     * @return int
     */
     ...
     *
     * @uses   ColibriERPWsdlClass::getInternArrayToIterateOffset()
     * @uses   ColibriERPWsdlClass::offsetExists()
     * @return bool true|false
     */
     ...
     *
     * @see   ColibriERPWsdlClass::offsetGet()
     * @uses  ColibriERPWsdlClass::offsetGet()
     * @param int $_index expect int
     *
     * @return mixed
     */
     ...
     *
     * @uses  ColibriERPWsdlClass::getAttributeName()
     * @uses  ColibriERPWsdlClass::__toString()
     * @uses  ColibriERPWsdlClass::_set()
     * @uses  ColibriERPWsdlClass::_get()
     * @uses  ColibriERPWsdlClass::setInternArrayToIterate()
     * @uses  ColibriERPWsdlClass::setInternArrayToIterateIsArray()
     * @uses  ColibriERPWsdlClass::setInternArrayToIterateOffset()
     ...
     *
     * @uses   ColibriERPWsdlClass::item()
     * @uses   ColibriERPWsdlClass::length()
     * @return mixed
     */
     ...
     *
     * @param mixed $_offset expect mixed
     * @param mixed $_value  expect mixed
     *
     * @return null
     */
     ...
     *
     * @param array $_lastError expect array
     *
     * @return array
     */
     ...
     *
     * @param array $_internArrayToIterate expect array
     *
     * @return array
     */
     ...
     *
     * @param int $_internArrayToIterateOffset expect int
     *
     * @return int
     */
     ...
     *
     * @param bool $_internArrayToIterateIsArray expect bool
     *
     * @return bool true|false
     */
